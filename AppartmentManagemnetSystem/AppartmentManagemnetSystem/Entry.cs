...
namespace AppartmentManagemnetSystem
{
    public partial class Entry : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'apartmentDataSet1.entry' table. You can move, or remove it, as needed.
          //  this.entryTableAdapter.Fill(this.apartmentDataSet1.entry);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string str = "INSERT INTO entry(person_name,date,time,vehicle_type,veh_no,owner,flat_no,wing) VALUES('" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox6.Text + "','" + textBox7.Text + "','" + textBox8.Text + "','" + textBox9.Text + "'); ";
                ...
                if (dr.Read())
                {
                    MessageBox.Show("New Entry Details Saved Successfully..");
                    textBox1.Text = "";
                    textBox2.Text = "";
                    textBox3.Text = "";
                    textBox4.Text = "";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "")
            {
                try
                {
                    string getCust = "select person_name,date,time,vehicle_type,veh_no,owner,flat_no,wing from entry where id=" + Convert.ToInt32(textBox1.Text) + " ;";
                    ...
                    {
                        MessageBox.Show(" Sorry, This ID, " + textBox1.Text + " entry Record is not Available.   ");
                        textBox1.Text = "";
                    }
                }
                catch (SqlException excep)
